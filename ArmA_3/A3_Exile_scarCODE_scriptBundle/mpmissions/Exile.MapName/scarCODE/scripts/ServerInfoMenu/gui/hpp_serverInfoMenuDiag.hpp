class SC_ServerInfoMenuDiag
{
	idd = 297;
	onLoad = "uiNamespace setVariable ['SC_ServerInfoMenuDisplay', _this select 0]; [] spawn SC_fnc_serverInfoMenuOnLoad; 'dynamicBlur' ppEffectAdjust [0.5]; 'dynamicBlur' ppEffectCommit 0.5";
	onUnLoad = "uiNamespace setVariable ['SC_ServerInfoMenuDisplay', nil]; 'dynamicBlur' ppEffectAdjust [0]; 'dynamicBlur' ppEffectCommit 0.2";
	// GUI GRID
	#define GUI_GRID_X	(0)
	#define GUI_GRID_Y	(0)
	...
	class RscStructuredText
	{
		...
		type = 13;
		style = 0;
		colorBackground[] = {0.075,0.11,0.094,0.7};
		colorText[] = {1,1,1,0.9};
		class Attributes
		{
			font = "PuristaMedium";
	...
	class controls
	{
		#include "hpp_serverInfoMenuRsc.hpp"
	};
};
