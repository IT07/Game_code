...
class sc_cfgServerInfoMenu
{
	...
	shortServerName = "Server Info Menu developed by IT07"; // Will be title of menu. This example fits exactly in the bar.
	...
	class 1 // First in _menuCategories
 	{
		...
		txtOne = "<t size='1.5'>EXAMPLE TITLE</t> <br /><br />";
